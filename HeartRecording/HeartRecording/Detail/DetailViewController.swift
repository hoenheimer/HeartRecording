...
class DetailViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewWillLayoutSubviews() {
        ...
        mainView.center = CGPoint(x: view.halfWidth(), y: view.height() * 0.4)
        ...
        playButton.center = CGPoint(x: view.halfWidth(), y: view.height() * 0.73)
        ...
        progressBackView.frame = CGRect(x: 40, y: view.height() * 0.86, width: view.width() - 80, height: progressImageView.height())
